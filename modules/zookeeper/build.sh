...
list_of_packages="${REPODIR_SRPMS}/${PACKNAME}-${VERSION}-${RELEASE}.el9.centos.src.rpm 
                ${REPODIR}/${PACKNAME}-${VERSION}-${RELEASE}.el9.centos.x86_64.rpm 
                ${REPODIR}/lib${PACKNAME}-${VERSION}-${RELEASE}.el9.centos.x86_64.rpm 
                ${REPODIR}/lib${PACKNAME}-devel-${VERSION}-${RELEASE}.el9.centos.x86_64.rpm 
                ${CACHEDIR}/${PACKNAME}-${VERSION}-${RELEASE}.el9.centos.x86_64.rpm
                ${CACHEDIR}/lib${PACKNAME}-${VERSION}-${RELEASE}.el9.centos.x86_64.rpm 
                ${CACHEDIR}/lib${PACKNAME}-devel-${VERSION}-${RELEASE}.el9.centos.x86_64.rpm"
